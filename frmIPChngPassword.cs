...
namespace LOB
{
    public partial class frmIPChngPassword : Form
    {
        ...
        private void FillSysUsers()
        {
            ...
            gPassword = HashCode(masterFiles.Password);
        }
        ...
        private long UpdatePassword()
        {
            MySqlCommand command = new MySqlCommand("UPDATE tblSysUsers SET Password = '" + HashCode(txtPassword.Text.Trim()) + "' WHERE Code = '" + txtCode.Text.Trim() + "' ", GlobalData.GCon);
