...
namespace LOB
{
    public partial class frmRptStockInfo : Form
    {
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            switch (cboBasedOn.SelectedIndex)
            {
                case 0:
                    ...
                    print.RoadToPrintReport(tmpQuery, @"C:\LOB\Bin\Debug\Rep\ProductSTKInfo.rpt", rptView);
                    break;
                case 1:
                ...
                case 2:
                    ...
                    print.RoadToPrintReport(tmpQuery, @"C:\LOB\Bin\Debug\Rep\ProductSTKCAT.rpt", rptView);
                    break;
                case 3:
                    tmpQuery = getQuery() + getSupplierID() + getStockroomID();
                    print.RoadToPrintReport(tmpQuery, @"C:\LOB\Bin\Debug\Rep\ProductSTKSUP.rpt", rptView);
                    break;
                default:
                    break;
            }
