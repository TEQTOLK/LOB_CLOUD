...
namespace LOB
{
    public partial class frmRptSales : Form
    {
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            {
                tmpQuery = GetQuery() + getDateRange() + getCustomerID() + getMOP() + getBranchID() ;
                print.RoadToPrintReport(tmpQuery, @"C:\LOB\Bin\Debug\Rep\Sales.rpt", rptView, "P", gCSHTotal, gCHQTotal, gCCSTotal, gCRETotal);
            }
