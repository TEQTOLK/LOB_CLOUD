...
namespace LOB
{
    public partial class frmIPCustomer : Form
    {
        ...
        private long SaveOrUpdateSupplier()
        {
            ...
            if (gEditFlag == false)
            {
                masterFiles.SaveCustomer();
                tmpID = 1;
            }
               
            else
                tmpID = masterFiles.UpdateCustomer();
        ...
        {
            MySqlCommand cmd = new MySqlCommand("DELETE FROM tblCustomer WHERE Code= '" + txtCode.Text + "' ", GlobalData.GCon);
            cmd.ExecuteNonQuery();
            return 1;
        }
        ...
        {
            masterFiles.FillCustomer(txtCode.Text.Trim());
        ...
        private void txtCode_Validating(object sender, CancelEventArgs e)
        {
            ...
            gSB.Clear();
            gSB.Append("SELECT Code FROM tblCustomer WHERE Code = '" + txtCode.Text.Trim() + "' ");
