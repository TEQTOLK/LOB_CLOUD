...
namespace LOB
{
    public partial class frmRptSUPList : Form
    {
        ...
        private string getCorrectQuery()
        {
            return "SELECT  CU.Add1 + ', ' + CU.Add2 + ', ' + CU.City AS CUAdd1,  " +
                ...
                " tblSupplier AS CU ON AR.CustID = CU.AreaID ";
        }
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            print.RoadToPrintReport(tmpQuery, @"C:\LOB\Bin\Debug\Rep\SupplierList.rpt", rptView);
