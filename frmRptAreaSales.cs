...
namespace LOB
{
    public partial class frmRptAreaSales : Form
    {
        ...
        private string GetQuery()
        {
            return "SELECT BR.DateOn AS BRDateOn, BR.BillNo AS BRBillNo, CU.Code AS CUCode, " +
                ...
                " MO.Bank AS CUDateOn, MO.CardCompany AS MOCard, CP.AreaID AS Discount, AR.NameOF AS CUNIC, CU.Tp1 AS E1Relationship " +
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            print.RoadToPrintReport(tmpQuery, @"C:\LOB\Bin\Debug\Rep\AreaSales.rpt", rptView, "P", gCSHTotal, gCHQTotal, gCCSTotal, gCRETotal);
