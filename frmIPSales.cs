...
namespace LOB
{
    public partial class frmIPSales : Form
    {
        ...
        private void fillProduct()
        {
            ...
            txtPrice.Text = string.Format("{0:N}", masterFiles.WholeSalePrice);
        ...
        private bool IsRequired()
        {
            ...
            gSB.Clear();
            gSB.Append("SELECT * FROM tblSaleBrief WHERE BillNo = '" + txtRefNo.Text.Trim() + "' ");
            if (GlbData.AlreadyExist(gSB.ToString()))
            {
