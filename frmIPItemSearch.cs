...
namespace LOB
{
    public partial class frmIPItemSearch : Form
    {
        ...
        {
            gSB.Clear();
            gSB.Append("SELECT CustID, Code, NameOF, BrandName, SerialNo, ModelNo " +
                       " FROM tblItem " +
                       " WHERE IsActive = 'Y' ");
            dSet = GlbData.getDataSet(gSB.ToString(), "tblSupplier");
        ...
        public void SettingGrid()
        {
            ...
            dgvItem.Columns[2].HeaderText = "Product Name";
            dgvItem.Columns[2].Width = 310;
            dgvItem.Columns[3].HeaderText = "Brand Name";
            dgvItem.Columns[3].Width = 200;
            dgvItem.Columns[4].HeaderText = "Serial No";
            dgvItem.Columns[4].Width = 100;
            dgvItem.Columns[5].HeaderText = "Model No";
